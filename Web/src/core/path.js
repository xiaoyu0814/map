...
let serverSystem = "http://172.16.10.55:8080"; //演示系统
...
var path = {
    PIEVector: {
        ...
        //ChinaProvince 线
        ChinaProvince: geoserver + "/geoserver/zhaojiawei/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=zhaojiawei:ChinaProvince-WGS1984&maxFeatures=100&outputFormat=application%2Fjson&id=ChinaProvince-WGS1984.1",
        //城市点数据
    ...
    GoogleURL: {
        ...
        s: "http://www.google.cn/maps/vt?lyrs=s@800&x={x}&y={y}&z={z}",
        //带标签的卫星图
    ...
    serverSystem: {
        yingxiang: serverSystem + "/PIE-Map-Data/images/yingxiang.jpg",
        xingzheng: serverSystem + "/PIE-Map-Data/images/xingzheng.jpg",
        dixing: serverSystem + "/PIE-Map-Data/images/dixing.jpg",
        compass: serverSystem + "/PIE-Map-Data/images/jt.svg", // 指北针
        jl: serverSystem + "/PIE-Map-Data/images/zy.svg", // openlayer卷帘
    }
}
export {
    path
