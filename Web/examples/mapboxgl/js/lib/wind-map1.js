 ...
 * div, callout, field, projection, animator
 */
var MotionDisplay = function(canvas, imageCanvas, field, numParticles, opt_projection) {
	this.canvas = canvas;
  this.projection = opt_projection//opt_projection || IDProjection;
  this.field = field;
...
return function (maptest) {
    ...
    var mapProjection = new ScaledAlbers(
        1000, 0, 800, -126.5, 23.5);
	var display = new MotionDisplay(mapcanvas, imageCanvas, field, numParticles,mapProjection);
