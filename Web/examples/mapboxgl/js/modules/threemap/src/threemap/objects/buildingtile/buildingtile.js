...
function BuildingTile(parent, map, threemap, material) {
    this.parent = parent;
	this.map = map;
...
BuildingTile.prototype.setVisible = function(visible) {
    if (this.group != null) {
        this.group.visible = visible;
    }
};

BuildingTile.prototype.isVisible = function() {
    if (this.group != null) {
...
BuildingTile.prototype.create = function(message, buffers) {
...
BuildingTile.prototype.destroy = function() {
