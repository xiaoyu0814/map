...
MeshLine3D.prototype.setGeometry = function( g, t ) {
	this.process( g, t );
}

MeshLine3D.prototype.compareV3 = function( a, b ) {
	var aa = a * 6;
	var ab = b * 6;
	return ( this.curr[ aa ] === this.curr[ ab ] ) && ( this.curr[ aa + 1 ] === this.curr[ ab + 1 ] ) && ( this.curr[ aa + 2 ] === this.curr[ ab + 2 ] );
}

MeshLine3D.prototype.copyV3 = function( a ) {
	var aa = a * 6;
	return [ this.curr[ aa ], this.curr[ aa + 1 ], this.curr[ aa + 2 ] ];
}

MeshLine3D.prototype.copyArray = function( a, b ) {
	for (var i = 0; i < a.length; i++) {
		a[i] = b[i];
	}
}

MeshLine3D.prototype.processLine = function(g, t) {
	this.curr = [];
	this.time = [];
...
MeshLine3D.prototype.process = function( g, t ) {
 ...
 * @param position
 */
MeshLine3D.prototype.advance = function(position) {
