...
function TerrainTile(parent, map, threemap, material) {
    this.parent = parent;
	this.map = map;
...
TerrainTile.prototype.setVisible = function(visible) {
    if (this.group != null) {
        this.group.visible = visible;
    }
};

TerrainTile.prototype.isVisible = function() {
    if (this.group != null) {
...
TerrainTile.prototype.create = function(message, buffers) {
