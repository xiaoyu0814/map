...
(function (global, factory) {
  ...
  var Windy = function (params) {
    ...
    var buildParams = function(params) {
      ...
      that.COLOR_SCALE = defaulColorScale;
    };
  ...
  if (!PIE.ol.layer) { PIE.ol.layer = {}; }
  if (!PIE.ol.layer.Image) { PIE.ol.layer.Image = /*@__PURE__*/(function () {
      function Image () {}
  ...
  var OlWind = /*@__PURE__*/(function (superclass) {
    function OlWind (data, options) {
      ...
      this.setSource(new PIE.ol.source.ImageCanvas({
        logo: options.logo,
        state: options.state,
    ...
    OlWind.prototype._getExtent = function _getExtent () {
      ...
      if (size && _extent) {
        ...
        var extent = PIE.ol.proj.transformExtent(_extent, _projection, 'EPSG:4326');
    ...
    OlWind.prototype.appendTo = function appendTo (map) {
      if (map && map instanceof PIE.ol.Map) {
