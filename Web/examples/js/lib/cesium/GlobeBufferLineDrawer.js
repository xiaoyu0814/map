...
GlobeBufferLineDrawer.prototype = {
    ...
    okHandler: null,
    cancelHandler: null,
    dragIcon: "image/circle_gray.png",
    dragIconLight: "image/circle_red.png",
    material: null,
    lineMaterial: null,
    fill: true,
    line: true,
    ...
    showModifyBufferLine: function (positions, radius, okHandler, cancelHandler) {
        ...
        _this._showModifyRegion2Map_edit();
    },
    ...
    _showModifyRegion2Map: function () {
        ...
        //20200526删掉绘制后的确定取消界面，让其走确定事件开始lxl
        _this.clear();
        layer.close(_this.toolBarIndex);
        if (_this.okHandler) {
            var positions = [];
        ...
        //20200526删掉绘制后的确定取消界面，让其走确定事件结束lxl
    },

    _showModifyRegion2Map_edit:function(){
        var _this = this;
